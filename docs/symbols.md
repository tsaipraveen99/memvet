...
The current resolver supports Python definitions, including top-level functions, async functions, class methods, and qualified names. Other languages retain the language-agnostic file-level fallback until a language adapter is added.
